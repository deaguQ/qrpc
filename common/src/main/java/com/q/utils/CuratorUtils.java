...
public final class CuratorUtils {
    ...
    public static final String ZK_REGISTER_ROOT_PATH = "/q-rpc";
    ...
    public static CuratorFramework getZkClient() {
        // todo check if user has set zk address
    ...
    public static void main(String[] args) throws Exception {
        ...
        createPersistentNode(getZkClient(),"/qiu/1");
        createPersistentNode(getZkClient(),"/qiu/2");
        List<String> childrenNodes = zkClient.getChildren().forPath("/q-rpc/com.q.service.HelloService");
        for(String s:childrenNodes){
            zkClient.delete().forPath("/q-rpc/com.q.service.HelloService"+"/"+s);
        }
        String join = String.join(" ", childrenNodes);
